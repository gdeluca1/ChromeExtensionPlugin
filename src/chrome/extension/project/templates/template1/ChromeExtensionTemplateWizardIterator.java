...
public class ChromeExtensionTemplateWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public ChromeExtensionTemplateWizardIterator() {
    }

    public static ChromeExtensionTemplateWizardIterator createIterator() {
        return new ChromeExtensionTemplateWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new ChromeExtensionTemplateWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(ChromeExtensionTemplateWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
